...
Функция: Принятие книги у читателя
  ...
  Сценарий: Успешная выдача книги
    ...
    Если я ввожу в поле "bookCode" значение "000001"
    И нажимаю на кнопку "Найти книгу"
    И я ввожу в поле "readerCode" значение "000002"
    И нажимаю на кнопку "Найти читателя"
