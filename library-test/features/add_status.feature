...
Функционал: Добавление статуса
  ...
  Сценарий: Добавление существуещего статуса книги
    ...
    И нажимаю на кнопку "Отправить"
    То появится ошибка "Такой статус уже существует"
  ...
  Сценарий:  Успешное удаление статуса книги
    ...
    То появляется плагин "Статус успешно удален"
  ...
  Сценарий:  Не успешное удаление статуса книги
    ...
    И нажимаю на кнопку "Delete"
    И нажимаю на кнопку "Удалить"
    То появляется плагин "Невозможно удалить статус, который используется"